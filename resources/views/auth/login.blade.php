...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-7" style="background-color: #3C5BBF">
            ...
            <p class="h4 text-center" style="color: white; margin-top: 20px; font-size: 30px"><b>Faça Login em sua conta para continuar</b></p>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary my-2 my-sm-0" id ="meu-botao2" style="padding-left: 30px; padding-right: 30px; font-size: 15px">
                                    {{ __('Entrar') }}
                                </button>
                            </div>
            </div>
